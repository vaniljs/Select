...
Так как <b>select</b> не стилизуется напрямую, работаем над его клоном <b>".select-wrapper"</b><br> Будем называть его псевдосписок. <br><br>
В примере помощью JavaScript синхронизируется взаимный выбор <b>option</b>
...
```JavaScript
     ...
     // Создание интуитивной иконки для псевдосписка
